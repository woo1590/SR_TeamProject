...
void InventoryUI::Update(float dt)
{
	...
	font->AddText(L"레벨", {102, 325, 250, 380}, Color::White, DT_LEFT | DT_TOP, FontType::TipText);
	font->AddText(L"" + to_wstring(info.level), {115,350,250,390}, Color::White, DT_LEFT | DT_TOP, FontType::TipText);
	font->AddText(L"힘", {505,320,580,500},Color::White, DT_LEFT | DT_TOP, FontType::TipText);
