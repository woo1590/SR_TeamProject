...
HRESULT Player::Ready_Object(ObjectManager* owner, ObjectType objType)
{
    ...
    Bones["LHand"]->GetComponent<TransformComponent>()->SetPivot(_vec3(11.0f, -10.f * Scale, 0.0f));
    ...
    Bones["RHand"]->GetComponent<TransformComponent>()->SetPivot(_vec3(-11.0f, -10.f * Scale, 0.0f));
    ...
    Bones["LLeg"]->GetComponent<TransformComponent>()->SetPivot(_vec3(4.0f, 12.f * Scale, 0.0f));
    ...
    Bones["RLeg"]->GetComponent<TransformComponent>()->SetPivot(_vec3(-4.0f, 12.f * Scale, 0.0f));
