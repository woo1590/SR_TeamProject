...
JungleZombie::~JungleZombie()
{
}

JungleZombie* JungleZombie::Create(ObjectManager* owner, ObjectType objType)
{
    JungleZombie* Instance = new JungleZombie(owner, objType);
...
HRESULT JungleZombie::Ready_Object(ObjectManager* owner, ObjectType objType)
{
...
void JungleZombie::Update(_float dt)
{
    Monster::Update(dt);
    PlayAnimation(dt);
}

void JungleZombie::Late_Update(_float dt)
{
    Monster::Late_Update(dt);
}

void JungleZombie::MoveTo(_vec3* dir, _float dt)
{
...
void JungleZombie::RotateTo(_vec3* dir, float dt)
{
}

void JungleZombie::Attack(Object* target)
{
...
void JungleZombie::Hit(_vec3 dir, _float power)
{
...
void JungleZombie::InitTransform(ObjectType objType)
{
    SetMaterial("JungleBody_Mtrl", "Body");
    SetMaterial("JungleFace_Mtrl", "Head");
    SetMaterial("JungleLeg_Mtrl", "LLeg");
    SetMaterial("JungleLeg_Mtrl", "RLeg");
    SetMaterial("JungleArm_Mtrl", "LArm");
    SetMaterial("JungleArm_Mtrl", "RArm");
    //Add_Bone("Ikki", ObjectType::Bone, Bones["Head"], "JungleFaceikki_Mtrl");
...
void JungleZombie::InitAnimation()
{
    //Walk
...
void JungleZombie::PlayAnimation(_float dt)
{
    switch (State)
    {
...
void JungleZombie::PlayIdle(_float dt)
{
    //idle animation
}

void JungleZombie::PlayWalk(_float dt)
{
    //walk animation
...
void JungleZombie::PlayAttack(_float dt)
{
    //attack animation
...
void JungleZombie::PlayDie(_float dt)
{
...
void JungleZombie::OnCollisionStay(Object* other)
{
